...
namespace Json
{
	...
	public:
		...
		virtual Json::JsonValue* operator=(unsigned int value);
		virtual Json::JsonValue* operator+(Json::JsonValue* value);
		...
		virtual void changeKey(std::string old_key, std::string new_key);
	...
	public:
		...
		Json::JsonValue* operator=(unsigned int value) override;
		Json::JsonValue* operator+(Json::JsonValue* value) override;
	...
	public:
		...
		void changeKey(std::string old_key, std::string new_key) override;
